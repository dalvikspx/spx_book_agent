...
function getTranslationExample(language) {
    const examples = {
        ...
        "Portuguese (European)": '"working hard" should be translated as "trabalhar arduamente" not "trabalhar quente"',
...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield (0, agents_1.run)(agent, `translate from page 51 to page 101 of the book to ${TARGET_LANGUAGE}`, {
        maxTurns: 1000,
    });
